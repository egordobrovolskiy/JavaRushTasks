...
//        return false;
        // второй способ
//        if (Modifier.isStatic(allModifiers) & Modifier.isStatic(specificModifier)) return true;
//        else if (Modifier.isPublic(allModifiers) & Modifier.isPublic(specificModifier)) return true;
//        else return false;
