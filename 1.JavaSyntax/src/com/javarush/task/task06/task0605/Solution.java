...
public class Solution {
    ...
    public static class Body {
        public static void massIndex(double weight, double height) {
            ...
            else if (x>=18.5 && x<=24.9) System.out.println("Нормальный: между 18.5 и 24.9");
            else if (x>=25 && x<=29.9) System.out.println("Избыточный вес: между 25 и 29.9");
            else if (x>=30) System.out.println("Ожирение: 30 или больше");
        }
    }
}
