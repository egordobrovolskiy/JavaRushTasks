...
public class Solution {
    public static void main(String[] args) {
        ...
        try {
            ...
            File your_file_name = new File ("C:\\Users\\dobro\\IdeaProjects\\JavaRushTasks\\2.JavaCore\\src\\com\\javarush\\task\\task20\\task2001\\1.dat");
    ...
    public static class Human {
        ...
        public void load(InputStream inputStream) throws Exception {
          ...
          String isAssetPresent = reader.readLine();
            ...
            assets.clear();
            while (reader.ready()) {
                Asset x = new Asset(reader.readLine());
                x.setPrice(Double.parseDouble(reader.readLine()));
                assets.add(x);
            }
        }
        reader.close();
